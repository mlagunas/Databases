...
public class OracleTemplate {
	...
	public static void main(String[] args) {
		...
		try {
			...
			q = new OracleTemplate(properties.getProperty("database.oracle.host"),
					properties.getProperty("database.oracle.port"),
					properties.getProperty("database.oracle.sid"),
					properties.getProperty("database.oracle.user"),
					properties.getProperty("database.oracle.password"));
